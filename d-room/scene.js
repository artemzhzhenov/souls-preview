...
/* Титул → «Первые строки»: камера проходит в 1.3 единицы от титульного
 * кадра — ближе, чем его собственная ширина, — и за 18 % прокрутки кадр
 * раздувается до 363 % высоты экрана и смахивается за левый край. Автор
 * назвал это рывком. Три ответа лежат
...
if (INTRO === 'fade') {
  ...
  // кадра на остановке прежнее (3.9), а мимо камера проходит не в 1.3
  // единицы, а в 3.0 — пик размера падает с 363 % до 310 %.
  BEATS[0].pace = SLOW;
